# خطة فصل الملف: `src/features/platformUpgrade/AdminPlatformUpgradeCenter.jsx`
...
- `AdminPlatformUpgradeCenter`
- `StatBox`

## الملفات المقترح فصلها منه
- `AdminPlatformUpgradeCenterView.jsx`
- `useAdminPlatformUpgradeCenterController.js`
- `AdminPlatformUpgradeCenterParts.jsx`
