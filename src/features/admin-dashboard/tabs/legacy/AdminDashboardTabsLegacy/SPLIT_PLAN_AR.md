# خطة فصل الملف: `src/features/admin-dashboard/tabs/legacy/AdminDashboardTabsLegacy.jsx`
...
- `AdminTabsNavigation.jsx`
- `AdminTabRenderer.jsx`
- `AdminDashboardTabContext.js`
