# خطة فصل الملف: `src/features/admin-dashboard/tabs/split/AdminSubscriptionsLegacyTab.jsx`
...
- `AdminSubscriptionsLegacyTab`

## الملفات المقترح فصلها منه
- `AdminSubscriptionsLegacyTabView.jsx`
- `useAdminSubscriptionsLegacyTabController.js`
- `AdminSubscriptionsLegacyTabParts.jsx`
