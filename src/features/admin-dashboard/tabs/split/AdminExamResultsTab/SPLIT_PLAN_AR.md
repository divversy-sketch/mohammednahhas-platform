# خطة فصل الملف: `src/features/admin-dashboard/tabs/split/AdminExamResultsTab.jsx`
...
- `AdminExamResultsTabView.jsx`
- `useAdminExamResultsTabController.js`
- `AdminExamResultsTabParts.jsx`
