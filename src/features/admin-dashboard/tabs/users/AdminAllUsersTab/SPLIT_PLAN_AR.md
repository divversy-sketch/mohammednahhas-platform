# خطة فصل الملف: `src/features/admin-dashboard/tabs/users/AdminAllUsersTab.jsx`
...
- `AdminAllUsersTabView.jsx`
- `useAdminAllUsersTabController.js`
- `AdminAllUsersTabParts.jsx`
