...
export const ROLE_TAB_ACCESS = Object.freeze({
  ...
  students_supervisor: ['dashboard', 'follow_up', 'users', 'all_users', 'student_reports', 'student_groups', 'parent_portal', 'messages_center', 'notifications_admin', 'password_resets'],
  content_supervisor: ['dashboard', 'content', 'courses', 'assignments', 'smart_hw', 'question_bank', 'smart_teacher', 'notifications_admin'],
